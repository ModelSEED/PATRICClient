...
my $shock = Bio::KBase::AppService::Shock->new("http://redwood.mcs.anl.gov:7078", token => Bio::P3::Workspace::ScriptHelpers::token());
my $awe = Bio::KBase::AppService::Awe->new($awe_server, token => Bio::P3::Workspace::ScriptHelpers::token());
